...
# on a Cartesian grid: (x, y). 
# You are also given an array points where each points[i] = [ai, bi] 
# represents that a point exists at (ai, bi). A point is valid if it 
...
# Manhattan distance from your current location. If there are multiple, return the valid point with the smallest index. If there are no valid points, return -1.
